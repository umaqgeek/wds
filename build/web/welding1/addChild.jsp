...
ArrayList<ArrayList<String>> we = component.getComponent("welder", 4);
...
ArrayList<ArrayList<String>> ft = component.getComponent("failure_tensile", 2);
...
<h3 class="panel-title">Add Strip Welding Job</h3>
<hr />
<!-- start validation -->
...
<div class="row">
    <div class="col-md-2">
        <div class="panel-body">
            <a class="btn btn-success" href="welding1/mainMenu.jsp?process=edit&id=<%=w_id %>">Back</a>
        </div>
    </div>
</div>
...
<div class="panel-body">
    <form onsubmit="return isFormNull();" class="form-horizontal" action="welding1/addchildprocess.jsp" role="form" name="f_addchild" id="f_addchild" method="post">
        ...
        <div class="form-group">
            <label for="wc_weldingnumber" class="col-lg-2 col-md-3 control-label">Welding Number</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" id="wc_weldingnumber" name="wc_weldingnumber" placeholder="Enter Welding Number">
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="ft_id" class="col-lg-2 col-md-3 control-label">If failed, tensile test?</label>
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" name="ft_id" id="ft_id">
                    <option value="0">-- Please Select Tensile Test --</option>
                    <% for(int i = 0; i < ft.size(); i++) { %>
                    <option value="<%=ft.get(i).get(0) %>"><%=ft.get(i).get(1) %></option>
                    <% } %>
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="wc_weldduration" class="col-lg-2 col-md-3 control-label">Welding Duration</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" id="wc_weldduration" name="wc_weldduration" placeholder="Enter Welding Duration">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" id="wc_spoolnumber" name="wc_spoolnumber" placeholder="Enter Spool Number">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" id="wc_bobbinnumber" name="wc_bobbinnumber" placeholder="Enter Bobbin Number">
            </div>
        </div>
