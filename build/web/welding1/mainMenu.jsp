...
<%
Welding well = new Welding();
Component component = new Component();
ArrayList<ArrayList<String>> welding = well.getAll(1);
ArrayList<ArrayList<String>> fp = component.getUniqueFP(1);
ArrayList<ArrayList<String>> m = component.getUniqueM(1);
ArrayList<String> sfnumber = well.getUnique("w_sfnumber", 1);
%>

<h3 class="panel-title warna-title">STRIP WELDING</h3>
<hr />
...
<div class="row">
    <div class="col-md-6">
        <div class="panel-body">
            ...
            <a class="tridik btn btn-success" href="welding1/mainMenu2.jsp?process=add">START</a>
        </div>
    </div>
</div>
<hr />
...
<div class="panel-body">
    <form class="form-horizontal" action="welding1/searchprocess.jsp" role="form" name="f_search" id="f_search" method="post">
         ...
         <tbody>
          ...
          <tr class="odd gradeA">
           ...
           <td><%=welding.get(i).get(1) %></td>
            ...
            <td class="center">
                <a href="welding1/searchprocess2.jsp?id=<%=welding.get(i).get(0) %>">
                ...
                <a onclick="return ask('Are you really want to delete this record?');" href="welding1/mainMenu2.jsp?process=delete&id=<%=welding.get(i).get(0) %>">
