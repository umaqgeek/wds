...
try {
    ...
    session.setAttribute("url_content", "welding1/add.jsp");
    session.setAttribute("url_menu", "menu/menuAdmin.jsp");
    session.setAttribute("url_stat", 2);
    response.sendRedirect("../index.jsp");
}
ArrayList<String> data = welding.getId(w_id, 1);
ArrayList<ArrayList<String>> data2 = wc.getAll(w_id);
if(data.size() <= 0) {
    session.setAttribute("url_content", "welding1/add.jsp");
    session.setAttribute("url_menu", "menu/menuAdmin.jsp");
    session.setAttribute("url_stat", 2);
...
<h3 class="panel-title warna-title">STRIP WELDING (CONTINUE PRODUCTION)</h3>
<hr />

<div class="row">
    <div class="col-md-2">
        <div class="panel-body">
            <a class="tridik btn btn-success" href="welding/mainMenu.jsp?w=1">Back</a>
        </div>
    </div>
</div>
...
<div class="panel-body">
    <form class="form-horizontal" action="welding1/editprocess.jsp" role="form" name="f_edit" id="f_edit" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select <%=readonly %> class="validate[required] form-control" data-prompt-position="topLeft:70" name="fp_id" id="fp_id">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <input <%=readonly %> value="<%=data.get(6) %>" type="text" data-prompt-position="topLeft:70" class="validate[required] form-control form-cascade-control" id="w_projectname" name="w_projectname" placeholder="Enter Project Name">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select <%=readonly %> class="validate[required] form-control" data-prompt-position="topLeft:70" name="m_id" id="m_id">
                    <option value="" <% if(data.get(7).equals("0")) { out.print("selected"); } %>>-- Please Select Machine --</option>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select <%=readonly %> class="validate[required] form-control" data-prompt-position="topLeft:70" name="wsize_id" id="wsize_id">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select <%=readonly %> class="validate[required] form-control" data-prompt-position="topLeft:70" name="sg_id" id="sg_id">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select <%=readonly %> class="validate[required] form-control" data-prompt-position="topLeft:70" name="wn_id" id="wn_id">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select <%=readonly %> class="validate[required] form-control" data-prompt-position="topLeft:70" name="sup_id" id="sup_id">
                    <option value="" <% if(data.get(15).equals("0")) { out.print("selected"); } %>>-- Please Select Supplier --</option>
                    <% for(int i = 0; i < sup.size(); i++) { %>
                    <option value="<%=sup.get(i).get(0) %>" <% if(data.get(15).equals(sup.get(i).get(0))) { out.print("selected"); } %>><%=sup.get(i).get(1) %></option>
                    <% } %>
                </select>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <% if(Integer.parseInt(session.getAttribute("ut_id").toString()) == 1) { %>
                ...
                <a class="tridik btn btn-danger" onclick="location.href='welding/mainMenu.jsp?w=1'"> Cancel </a>
            <% } %>
            </div>
        </div>
    </form>
...
<!--<div class="row">
    <div class="col-md-2">
        <div class="panel-body">
            <a class="btn btn-success" href="welding1/mainMenu.jsp?process=addChild&id=<%=w_id %>">Add</a>
        </div>
    </div>
</div>-->
         ...
         <tbody>
          ...
          <tr class="odd gradeA">
           ...
           <td><%=data2.get(i).get(3) %></td>
            ...
            <td><%=data2.get(i).get(22) %></td>
            <td><%=data2.get(i).get(21) %></td>
            ...
            <td class="center">
                ...
                <a onclick="return ask('Are you really want to delete this record?');" href="welding1/mainMenu2.jsp?process=deleteChild&id=<%=data2.get(i).get(0) %>&w_id=<%=w_id %>">
...
<div class="row">
    <div class="col-md-2">
        <div class="panel-body">
            <a class="tridik btn btn-success" href="welding1/mainMenu2.jsp?process=edit&id=<%=w_id %>">Back</a>
        </div>
    </div>
</div>
...
<div class="panel-body">
    <form class="form-horizontal" action="welding1/addchildprocess.jsp" role="form" name="f_addchild" id="f_addchild" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="t_id" id="t_id">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="we_id" id="we_id">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="wm_id" id="wm_id">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <input type="text" data-prompt-position="topLeft:70" class="validate[required] form-control form-cascade-control" id="wc_weldlength" name="wc_weldlength" placeholder="Enter Welding Length (m)">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="ws_id" id="ws_id">
        ...
        <div class="form-group">
            <label for="wc_coilnumber" class="col-lg-2 col-md-3 control-label">Coil Number</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" data-prompt-position="topLeft:70" class="validate[required] form-control form-cascade-control" id="wc_coilnumber" name="wc_coilnumber" placeholder="Enter Coil Number">
            </div>
        </div>
                
        <div class="form-group">
            <label for="wc_bobbinnumber" class="col-lg-2 col-md-3 control-label">Bobbin Number</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" data-prompt-position="topLeft:70" class="validate[required] form-control form-cascade-control" id="wc_bobbinnumber" name="wc_bobbinnumber" placeholder="Enter Bobbin Number">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                ...
                <input type="hidden" name="wc_status" id="wc_status" value="1" />
...
<div class="panel-body">
    <form class="form-horizontal" action="welding1/editcomments.jsp" role="form" name="f_editcomments" id="f_editcomments" method="post">
        ...
        <div class="form-group">
            <label for="t_id" class="col-lg-2 col-md-3 control-label">Team</label>
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="t_id_komen" id="t_id_komen">
                    <option value="">-- Please Select Team --</option>
                    <% for(int i = 0; i < t.size(); i++) { %>
                    <option value="<%=t.get(i).get(0) %>"><%=t.get(i).get(1) %></option>
                    <% } %>
        ...
        <div class="form-group">
            <label for="we_id" class="col-lg-2 col-md-3 control-label">Welder</label>
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="we_id_komen" id="we_id_komen">
                    <option value="">-- Please Select Welder --</option>
                    <% for(int i = 0; i < we.size(); i++) { %>
                    <option value="<%=we.get(i).get(0) %>">(<%=we.get(i).get(1) %>) <%=we.get(i).get(2) %>
                    (<%
        ...
        <div class="form-group">
            <label for="wm_id" class="col-lg-2 col-md-3 control-label">Welding Machine</label>
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="wm_id_komen" id="wm_id_komen">
                    <option value="">-- Please Select Welding Machine --</option>
                    <% for(int i = 0; i < wm.size(); i++) { %>
                    <option value="<%=wm.get(i).get(0) %>"><%=wm.get(i).get(1) %></option>
                    <% } %>
        ...
        <div class="form-group">
            <label for="wc_weldlength" class="col-lg-2 col-md-3 control-label">Weld Length (m)</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" data-prompt-position="topLeft:70" class="validate[required] form-control form-cascade-control" id="wc_weldlength_komen" name="wc_weldlength_komen" placeholder="Enter Welding Length (m)">
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="ws_id" class="col-lg-2 col-md-3 control-label">Weld Status</label>
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="ws_id_komen" id="ws_id_komen">
                    <option value="">-- Please Select Weld Status --</option>
                    <% for(int i = 0; i < ws.size(); i++) { %>
                    <option value="<%=ws.get(i).get(0) %>"><%=ws.get(i).get(1) %></option>
                    <% } %>
        ...
        <div class="form-group">
            <label for="fc_id" class="col-lg-2 col-md-3 control-label">If failed, why?</label>
            <div class="col-lg-10 col-md-9">
                <select class="form-control" name="fc_id_komen" id="fc_id_komen">
                    <option value="0">-- Please Select Failure Caused --</option>
                    <% for(int i = 0; i < fc.size(); i++) { %>
                    <option value="<%=fc.get(i).get(0) %>"><%=fc.get(i).get(1) %></option>
                    <% } %>
        ...
        <div class="form-group">
            <label for="wc_coilnumber" class="col-lg-2 col-md-3 control-label">Coil Number</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" data-prompt-position="topLeft:70" class="validate[required] form-control form-cascade-control" id="wc_coilnumber_komen" name="wc_coilnumber_komen" placeholder="Enter Coil Number">
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="wc_bobbinnumber" class="col-lg-2 col-md-3 control-label">Bobbin Number</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" data-prompt-position="topLeft:70" class="validate[required] form-control form-cascade-control" id="wc_bobbinnumber_komen" name="wc_bobbinnumber_komen" placeholder="Enter Bobbin Number">
            </div>
        </div>
...
<div class="row">
    <div class="col-md-3">
        <a target="_blank" href="welding1/print.jsp?id=<%=w_id %>">
