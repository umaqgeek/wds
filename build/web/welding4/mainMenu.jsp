...
ArrayList<ArrayList<String>> welding = weldin.getAll(4);
ArrayList<ArrayList<String>> fp = component.getUniqueFP(4);
ArrayList<ArrayList<String>> m = component.getUniqueM(4);
ArrayList<String> sfnumber = weldin.getUnique("w_sfnumber", 4);
%>

<h3 class="panel-title warna-title">CARCASS STOP RING</h3>
<hr />
...
<div class="row">
    <div class="col-md-6">
        <div class="panel-body">
            ...
            <a class="tridik btn btn-success" href="welding4/mainMenu2.jsp?process=add">START</a>
        </div>
    </div>
</div>
<hr />
...
<div class="panel-body">
    <form class="form-horizontal" action="welding4/searchprocess.jsp" role="form" name="f_search" id="f_search" method="post">
         ...
         <tbody>
          ...
          <tr class="odd gradeA">
           ...
           <td><%=welding.get(i).get(1) %></td>
            ...
            <td class="center">
                <a href="welding4/searchprocess2.jsp?id=<%=welding.get(i).get(0) %>">
                ...
                <a onclick="return ask('Are you really want to delete this record?');" href="welding4/mainMenu2.jsp?process=delete&id=<%=welding.get(i).get(0) %>">
