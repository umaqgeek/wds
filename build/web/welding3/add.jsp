...
<h3 class="panel-title warna-title">RABOUTAGE (NEW PRODUCTION)</h3>
<hr />
...
<div class="panel-body">
    <form class="form-horizontal" action="welding3/addprocess.jsp" role="form" name="f_add" id="f_add" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                ...
                <input type="hidden" name="w_status" id="w_status" value="3" />
