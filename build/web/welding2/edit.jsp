...
ArrayList<String> data = welding.getId(w_id, 2);
...
<h3 class="panel-title warna-title">WIRE WELDING (CONTINUE PRODUCTION)</h3>
<hr />
...
<div class="panel-body">
    <form class="form-horizontal" action="welding2/editprocess.jsp" role="form" name="f_edit" id="f_edit" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select <%=readonly %> class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" name="sup_id" id="sup_id">
...
<!--<div class="row">
    <div class="col-md-2">
        <div class="panel-body">
            <a class="tridik btn btn-success" href="welding1/mainMenu.jsp?process=addChild&id=<%=w_id %>">Add</a>
        </div>
    </div>
</div>-->
...
<table class="table table-bordered table-hover table-striped display" id="example_wire" >
           <thead>
            <tr>
             <th>No.</th>
             <th>Team</th>
             ...
             <th>Weld Status</th>
             <th>If failed, why?</th>
             <th>If failed, Tensile test? (Mpa)</th>
         ...
         <tbody>
          ...
          <tr class="odd gradeA">
           ...
           <td><%=data2.get(i).get(3) %></td>
            ...
            <td><%=data2.get(i).get(12) %></td>
            <td><%=data2.get(i).get(15) %></td>
            <td><%=data2.get(i).get(17) %></td>
            <td><%=data2.get(i).get(18) %></td>
            <td><%=data2.get(i).get(19) %></td>
            <td><%=data2.get(i).get(20) %></td>
            ...
            <td class="center">
                ...
                <a onclick="return ask('Are you really want to delete this record?');" href="welding2/mainMenu2.jsp?process=deleteChild&id=<%=data2.get(i).get(0) %>&w_id=<%=w_id %>">
...
<div class="row">
    <div class="col-md-2">
        <div class="panel-body">
            <a class="tridik btn btn-success" href="welding2/mainMenu2.jsp?process=edit&id=<%=w_id %>">Back</a>
        </div>
    </div>
</div>
...
<div class="panel-body">
    <form class="form-horizontal" action="welding2/addchildprocess.jsp" role="form" name="f_addchild" id="f_addchild" method="post">
        ...
        <div class="form-group">
            <label for="wc_weldingnumber" class="col-lg-2 col-md-3 control-label">Weld Number</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" id="wc_weldingnumber" name="wc_weldingnumber" placeholder="Enter Welding Number">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" name="ws_id" id="ws_id">
                    <option value="">-- Please Select Welding Status --</option>
        ...
        <div class="form-group">
            <label for="wc_failuretensile" class="col-lg-2 col-md-3 control-label">If failed, Tensile Test (Mpa)</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="form-control form-cascade-control" id="wc_failuretensile" name="wc_failuretensile" placeholder="Enter If failed, Tensile Test (Mpa)">
            </div>
        </div>
                
        <div class="form-group">
            <label for="wc_weldduration" class="col-lg-2 col-md-3 control-label">Weld Duration (Sec)</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" id="wc_weldduration" name="wc_weldduration" placeholder="Enter Welding Duration">
            </div>
        </div>
        
        <div class="form-group">
            <label for="wc_spoolnumber" class="col-lg-2 col-md-3 control-label">Spool Number</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" id="wc_spoolnumber" name="wc_spoolnumber" placeholder="Enter Spool Number">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" id="wc_bobbinnumber" name="wc_bobbinnumber" placeholder="Enter Bobbin Number">
            </div>
        </div>
...
<div class="panel-body">
    <form class="form-horizontal" action="welding2/editcomments.jsp" role="form" name="f_editcomments" id="f_editcomments" method="post">
        ...
        <div class="form-group">
            <label for="wc_weldingnumber" class="col-lg-2 col-md-3 control-label">Weld Number</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" id="wc_weldingnumber_komen" name="wc_weldingnumber_komen" placeholder="Enter Welding Number">
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="wc_failuretensile" class="col-lg-2 col-md-3 control-label">If failed, Tensile Test (Mpa)</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="form-control form-cascade-control" id="wc_failuretensile_komen" name="wc_failuretensile_komen" placeholder="Enter If failed, Tensile Test (Mpa)">
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="wc_weldduration" class="col-lg-2 col-md-3 control-label">Weld Duration (Sec)</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" id="wc_weldduration_komen" name="wc_weldduration_komen" placeholder="Enter Welding Duration">
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="wc_spoolnumber" class="col-lg-2 col-md-3 control-label">Spool Number</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" id="wc_spoolnumber_komen" name="wc_spoolnumber_komen" placeholder="Enter Spool Number">
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="wc_bobbinnumber" class="col-lg-2 col-md-3 control-label">Bobbin Number</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" id="wc_bobbinnumber_komen" name="wc_bobbinnumber_komen" placeholder="Enter Bobbin Number">
            </div>
        </div>
...
<div class="row">
    <div class="col-md-3">
        <a target="_blank" href="welding2/print.jsp?id=<%=w_id %>">
