...
<table width="100%" cellpadding="5" align="center">
  <tr>
    <td>&nbsp;</td>
    <td rowspan="4" align="center"><img src="assets/images/mainpage_technip.png" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>
    ...
    <td><a href="welding/mainMenu.jsp?w=3">
              <div class="info-box  bg-info  text-white">
                <div class="info-icon bg-info-dark">
  ...
  <tr>
    <td><a href="welding/mainMenu.jsp?w=1">
              <div class="info-box  bg-info  text-white">
                <div class="info-icon bg-info-dark">
    ...
    <td><a href="welding/mainMenu.jsp?w=4">
              <div class="info-box  bg-info  text-white">
                <div class="info-icon bg-info-dark">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><a href="welding/mainMenu.jsp?w=5">
              <div class="info-box  bg-info  text-white">
                <div class="info-icon bg-info-dark">
  ...
  <tr>
    <td><a href="welding/mainMenu.jsp?w=8">
              <div class="info-box  bg-info  text-white">
                <div class="info-icon bg-info-dark">
    ...
    <td><a href="welding/mainMenu.jsp?w=7">
              <div class="info-box  bg-info  text-white">
                <div class="info-icon bg-info-dark">
                  <i class="fa fa-cogs fa-4x">
                  </i>
    ...
    <td> <a href="welding/mainMenu.jsp?w=6">
              <div class="info-box  bg-info  text-white">
                <div class="info-icon bg-info-dark">
