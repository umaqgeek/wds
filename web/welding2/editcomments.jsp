...
column.add("wc_weldingnumber"); data.add(request.getParameter("wc_weldingnumber_komen")); tanda.add(1);
...
column.add("wc_failuretensile"); data.add(request.getParameter("wc_failuretensile_komen")); tanda.add(1);
column.add("wc_weldduration"); data.add(request.getParameter("wc_weldduration_komen")); tanda.add(1);
column.add("wc_spoolnumber"); data.add(request.getParameter("wc_spoolnumber_komen")); tanda.add(1);
column.add("wc_bobbinnumber"); data.add(request.getParameter("wc_bobbinnumber_komen")); tanda.add(1);
