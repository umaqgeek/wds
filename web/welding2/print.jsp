...
<h3 class="panel-title">WIRE Welding</h3>
<hr />
...
<table border="1" class="table table-bordered table-hover table-striped display" id="example" >
           <thead>
            <tr>
             <th>No.</th>
             <th>Team</th>
         ...
         <tbody>
          ...
          <% } } else { %>
          <tr class="odd gradeA">
              <td colspan="15"><em>No Record ..</em></td>
          </tr>
          <% } %>
           </tbody>
       </table>
