...
<h3 class="panel-title warna-title" >STRIP WELDING (NEW PRODUCTION)</h3>
<hr />
...
<div class="panel-body">
    <form class="form-horizontal" action="welding1/addprocess.jsp" role="form" name="f_add" id="f_add" method="post">
   ...
   <input type="text" class="validate[required] form-control form-cascade-control"  data-prompt-position="topLeft:70" id="w_sfnumber" name="w_sfnumber" placeholder="Enter SF Number">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="fp_id" id="fp_id">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <input type="text" data-prompt-position="topLeft:70" class="validate[required] form-control form-cascade-control" id="w_projectname" name="w_projectname" placeholder="Enter Project Name">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="m_id" id="m_id">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="wsize_id" id="wsize_id">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control" data-prompt-position="topLeft:70" name="wn_id" id="wn_id">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                ...
                <input type="hidden" name="w_status" id="w_status" value="1" />
