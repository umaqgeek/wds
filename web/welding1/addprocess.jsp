...
if(err.length() > 1) {
    ...
    //Starter.setUrl_content("welding1/add.jsp");
    session.setAttribute("url_content", "welding1/add.jsp");
} else {
    //Starter.setUrl_content("welding1/edit.jsp?id="+ser.get(0));
    session.setAttribute("url_content", "welding1/edit.jsp?id="+ser.get(0));
}
