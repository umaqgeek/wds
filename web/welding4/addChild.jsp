...
<h3 class="panel-title">Add Carcass Stop Ring Job</h3>
<hr />
<!-- start validation -->
...
<div class="row">
    <div class="col-md-2">
        <div class="panel-body">
            <a class="btn btn-success" href="welding4/mainMenu.jsp?process=edit&id=<%=w_id %>">Back</a>
        </div>
    </div>
</div>
...
<div class="panel-body">
    <form class="form-horizontal" action="welding4/addchildprocess.jsp" role="form" name="f_addchild" id="f_addchild" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" id="wc_efposition" name="wc_efposition" placeholder="Enter EF Position (m)">
            </div>
        </div>
