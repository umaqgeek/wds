...
try {
    ...
    if(process.equals("add")) {
        ...
        String id = request.getParameter("id");
        session.setAttribute("url_content", "welding4/delete.jsp?id="+id);
        session.setAttribute("url_menu", "menu/menuAdmin.jsp");
        session.setAttribute("url_stat", 2);
        response.sendRedirect("../index.jsp");
    } else if(process.equals("addChild")) {
        String id = request.getParameter("id");
        session.setAttribute("url_content", "welding4/addChild.jsp?id="+id);
        session.setAttribute("url_menu", "menu/menuAdmin.jsp");
        session.setAttribute("url_stat", 2);
        response.sendRedirect("../index.jsp");
        ...
        session.setAttribute("url_content", "welding4/deleteChild.jsp?id="+id+"&w_id="+w_id);
        session.setAttribute("url_menu", "menu/menuAdmin.jsp");
        session.setAttribute("url_stat", 2);
        response.sendRedirect("../index.jsp");
    }
