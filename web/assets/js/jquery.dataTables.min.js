 ...
 */(function(i, V, l, n) {
    var j = function(e) {
        ...
        function za(e) {
            var t = e.oPreviousSearch, n = e.oLanguage.sSearch, n = -1 !== n.indexOf("_INPUT_") ? n.replace("_INPUT_", '<input type="text" class="pull-right" />') : "" === n ? '<input type="text"  class="form-control" />' : n + ' <input type="text"  class="form-control"  />', r = l.createElement("div");
