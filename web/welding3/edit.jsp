...
<h3 class="panel-title warna-title">RABOUTAGE (CONTINUE PRODUCTION)</h3>
<hr />

<div class="row">
    <div class="col-md-2">
        <div class="panel-body">
            <a class="tridik btn btn-success" href="welding/mainMenu.jsp?w=3">Back</a>
        </div>
    </div>
</div>
...
<div class="panel-body">
    <form class="form-horizontal" action="welding3/editprocess.jsp" role="form" name="f_edit" id="f_edit" method="post">
        ...
        <div class="row">
            ...
            <% if(Integer.parseInt(session.getAttribute("ut_id").toString()) == 1) { %>
                ...
                <a class="tridik btn btn-danger" onclick="location.href='welding/mainMenu.jsp?w=3'"> Cancel </a>
            <% } %>
            </div>
        </div>
    </form>
          ...
          <tr class="odd gradeA">
           ...
           <td><%=data2.get(i).get(3) %></td>
            ...
            <td class="center">
                ...
                <a onclick="return ask('Are you really want to delete this record?');" href="welding3/mainMenu2.jsp?process=deleteChild&id=<%=data2.get(i).get(0) %>&w_id=<%=w_id %>">
...
<div class="row">
    <div class="col-md-2">
        <div class="panel-body">
            <a class="tridik btn btn-success" href="welding3/mainMenu2.jsp?process=edit&id=<%=w_id %>">Back</a>
        </div>
    </div>
</div>
...
<div class="panel-body">
    <form class="form-horizontal" action="welding3/addchildprocess.jsp" role="form" name="f_addchild" id="f_addchild" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" name="wp_id" id="wp_id">
                    <option value="">-- Please Select Welding Process --</option>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" id="wc_weldlength" name="wc_weldlength" placeholder="Enter Welding Length (m)">
            </div>
        </div>
...
<div class="panel-body">
    <form class="form-horizontal" action="welding3/editcomments.jsp" role="form" name="f_editcomments" id="f_editcomments" method="post">
        ...
        <div class="form-group">
            <label for="wp_id" class="col-lg-2 col-md-3 control-label">Welding Process</label>
            <div class="col-lg-10 col-md-9">
                <select class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" name="wp_id_komen" id="wp_id_komen">
                    <option value="">-- Please Select Welding Process --</option>
                    <% for(int i = 0; i < wp.size(); i++) { %>
                    <option value="<%=wp.get(i).get(0) %>"><%=wp.get(i).get(1) %></option>
                    <% } %>
        ...
        <div class="form-group">
            <label for="wc_weldlength" class="col-lg-2 col-md-3 control-label">Weld Length (m)</label>
            <div class="col-lg-10 col-md-9">
                <input type="text" class="validate[required] form-control form-cascade-control" data-prompt-position="topLeft:70" id="wc_weldlength_komen" name="wc_weldlength_komen" placeholder="Enter Welding Length (m)">
            </div>
        </div>
...
<div class="row">
    <div class="col-md-3">
        <a target="_blank" href="welding3/print.jsp?id=<%=w_id %>">
